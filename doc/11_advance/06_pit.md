# Pit render engine
The Pit is a engine to render loza code inside the Html/Text code(PIT: Loza in Text).
...
```bash
$ loza @pit /path/to/file.html
```

## Use as library
Also you can use this system as a library in your loza code.
